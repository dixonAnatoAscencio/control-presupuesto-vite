...
const handleNuevoGasto = () =>{
  ...
  const guardarGasto = gasto =>{
    console.log(gasto)
    if(gasto.id){
      //Actualizar NOS va a retornar un nuevo arreglo en esta variable
  ...
  const eliminarGasto = id =>{
    //usamos un .filter para sacar ese elemento que deseamos eliminar
    // y que nos traiga el id diferente al que estamos pasando 
